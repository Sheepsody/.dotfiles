...
(use-package org-pomodoro
  ...
  (setq
   ...
   org-pomodoro-short-break-sound (concat "~/.doom.d/random/cat_meow.mp3")
   org-pomodoro-long-break-sound (concat "~/.doom.d/random/cat_meow.mp3")
   org-pomodoro-overtime-sound (concat "~/.doom.d/random/cat_meow.mp3")
   org-pomodoro-finished-sound (concat "~/.doom.d/random/cat_meow.mp3")))
...
(use-package! org-journal
  ...
  (add-to-list 'org-capture-templates
               `("j" "Journal entry" entry (function org-journal-find-location)
                 "** %^{Event status? |MEETING |TODO |NEXT |WAITING |DONE | }%(format-time-string org-journal-time-format)%^{Title}\n%i%?"
