...
(use-package! org-journal
  ...
  (add-to-list 'org-capture-templates
               `("d" "Daily journal" entry (function org-journal-find-location)
                 (file ,(expand-file-name "~/Dropbox/emacs/Org/daily.org"))
                 :jump-to-captured t :immediate-finish t))
  (add-to-list 'org-capture-templates
...
(use-package elfeed
  ...
  (setq elfeed-feeds    '((
                           "fever+https://Sheepsody@rss.sheepsody.com"
                           :api-url "https://Sheepsody@rss.sheepsody.com/api/fever.php"
                           :password "R%6q5zdCm4NgddTW"))))
#+end_src
