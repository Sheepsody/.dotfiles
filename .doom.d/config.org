...
#+begin_src elisp
(if (string-equal system-name "Victors-MacBook-Pro.local")
    ((setq org-directory (expand-file-name "~/Org/"))
     org-roam-directory (expand-file-name "~/Dropbox/emacs/Roam/")
     elfeed-db-directory "~/.elfeed/"
     rmh-elfeed-org-files (list (concat org-directory "elfeed/elfeed.org")))
  ;; Else
  ((setq org-directory (expand-file-name "cccccc~/Org/"))
   org-roam-directory (expand-file-name "~/Dropbox/emacs/Roam/")
   elfeed-db-directory "~/.elfeed/"
   rmh-elfeed-org-files (list (concat org-directory "elfeed/elfeed.org"))))
#+end_src
